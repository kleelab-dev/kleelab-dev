...
BackgroundTone = Literal["default", "paper", "canvas", "ink", "mint", "accent"]
TextTone = Literal["ink", "muted", "paper", "accent"]
...
class NodeStyle(BaseModel):
    """Token-based styling; mirrors the Tailwind token maps in the frontend."""

    model_config = ConfigDict(extra="forbid")

    background: BackgroundTone | None = None
    color: TextTone | None = None
